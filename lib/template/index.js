...
exports.PackageTemplate = exports.ScssTemplate = exports.HtmlTemplate = exports.WebpackTemplate = exports.BootstrapTemplate = exports.AppTemplate = void 0;

var PackageTemplate = function PackageTemplate(name) {
  return "{\n  \"name\": \"".concat(name, "\",\n  \"version\": \"1.0.0\",\n  \"license\": \"MIT\",\n  \"scripts\": {\n    \"dev\": \"wp5 dev\",\n    \"build\": \"wp5 build\"\n  },\n  \"devDependencies\": {\n    \"wmf-cli\": \"file:../wmf-cli\"\n  },\n  \"dependencies\": {\n    \"react\": \"^17.0.1\",\n    \"react-dom\": \"^17.0.1\"\n  }\n}\n");
};
